    ...
    return {
        ...
        init: function(options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    "dom": "<'row'<'col-md-8 col-sm-12'pli><'col-md-4 col-sm-12'f>r><'table-scrollable't><'row'<'col-md-8 col-sm-12'pli><'col-md-4 col-sm-12'<'table-group-actions pull-right'>>>", // datatable layout
                    "pageLength": 10, // default records per page
                    "language": { // language settings
                        // metronic spesific
                        "metronicGroupActions": "_TOTAL_ selected: ",
                        "metronicAjaxRequestGeneralError": "请求异常，请确认网络连接是否正常",

                        // data tables spesific
                        "lengthMenu": "<span class='seperator'>|</span>每页 _MENU_ 条",
                        "info": "<span class='seperator'>|</span>总记录 _TOTAL_ 条",
                        "infoEmpty": "暂无记录",
                        "emptyTable": "暂无记录",
