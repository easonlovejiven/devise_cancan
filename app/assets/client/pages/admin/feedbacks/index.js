...
$(function() {
    ...
    TableAjax.init(el.find('.com-datatable-ajax'), {
        'columnDefs': [{
            ...
            "orderable": false,
            "render": function(data, type, full) {
                return '<a href="/admin/feedbacks/' + data + '/edit" class="btn default btn-xs purple"><i class="fa fa-edit"></i> 编辑</a><a href="/admin/feedbacks/' + data + '" class="btn default btn-xs black" data-method="delete" data-confirm="确定删除此条记录吗？"><i class="fa fa-trash-o"></i> 删除</a>';
            }
        }],
    });
});